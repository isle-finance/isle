...
contract Defaults is Constants {
    ...
    // Pool
    string public constant POOL_NAME = "ISLE Green Share";
    string public constant POOL_SYMBOL = "IGS";
    ...
    string public constant MARKET_ID = "ISLE Green Finance";
    string public constant NEW_MARKET_ID = "ISLE Green Finance 2";
